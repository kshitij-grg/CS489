...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeData() {
        ...
        // Create Roles
        Role officeManagerRole = new Role("Office Manager");
        roleRepository.save(officeManagerRole);

        // Create Users
        User user1 = new User("admin", "password123", "John", "Doe", officeManagerRole);
        User user2 = new User("manager", "password123", "Jane", "Smith", officeManagerRole);
